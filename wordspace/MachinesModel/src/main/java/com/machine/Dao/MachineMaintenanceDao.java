...
public class MachineMaintenanceDao {
	...
	public List<MachineMaintenanceBean> findAllMaintenances() throws Exception {
		...
		try (Connection conn = DBUtil.getConnection();
			...
			while (rs.next()) {
				...
				MachineMaintenanceBean maintenance = new MachineMaintenanceBean(scheduleId, machineId, scheduleDate,
	...
	// 分頁查詢保養排程
	public List<MachineMaintenanceBean> findAllWithPaging(int offset, int limit) throws Exception {
		List<MachineMaintenanceBean> list = new ArrayList<>();
		String sql = "SELECT * FROM machine_maintenance ORDER BY schedule_date DESC OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
